...
public partial class C_HL2MP_Player : C_BaseHLPlayer
{
	...
	]); public static readonly ClientClass CC_HL2MPLocalPlayerExclusive = ClientClass.New("HL2MPLocalPlayerExclusive", null, null, DT_HL2MPLocalPlayerExclusive);
	...
	public static readonly RecvTable DT_HL2MPNonLocalPlayerExclusive = new([
		...
		RecvPropFloat(FIELD.OF_VECTORELEM(nameof(EyeAngles), 0)),
		RecvPropFloat(FIELD.OF_VECTORELEM(nameof(EyeAngles), 1)),
	]); public static readonly ClientClass CC_HL2MPNonLocalPlayerExclusive = ClientClass.New("HL2MPNonLocalPlayerExclusive", null, null, DT_HL2MPNonLocalPlayerExclusive);
	...
	public static readonly new ClientClass ClientClass = ClientClass.New("HL2MP_Player", null, null, DT_HL2MP_Player)
															.WithManualClassID(StaticClassIndices.CHL2MP_Player).WithAutoEntityCreateFn<C_HL2MP_Player>();
