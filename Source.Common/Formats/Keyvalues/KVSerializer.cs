...
using Source.Common.Formats.Keyvalues.Deserialization;
using Source.Common.Formats.Keyvalues.Serialization.KeyValues1;
using Source.Common.Formats.Keyvalues.Deserialization.KeyValues1;
...
namespace Source.Common.Formats.Keyvalues
{
	...
	public class KVSerializer
	{
		...
		public KeyValues Deserialize(Stream stream, KVSerializerOptions options = null) {
			...
			return new KeyValues(root.Name, root.Value);
		}
		...
		public void Serialize(Stream stream, KeyValues data, KVSerializerOptions options = null) {
