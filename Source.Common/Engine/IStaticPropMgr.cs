...
public interface IStaticPropMgr
{
	...
	void TraceRayAgainstStaticProp(Ray_t ray, int staticPropIndex, trace_t tr);
...
public interface IStaticPropMgrClient : IStaticPropMgr
{
	...
	void AddDecalToStaticProp(Vector3 rayStart, Vector3 rayEnd, int staticPropIndex, int decalIndex, bool doTrace, trace_t tr);
	...
	void GetStaticPropMaterialColorAndLighting(trace_t trace, int staticPropIndex, out Vector3 lighting, out Vector3 matColor);
