...
public class BaseCombatCharacter : BaseFlex
{
	...
	public static readonly ServerClass CC_BCCLocalPlayerExclusive = ServerClass.New(DT_BCCLocalPlayerExclusive);
	...
	public static readonly new ServerClass ServerClass = ServerClass.New(DT_BaseCombatCharacter).WithManualClassID(StaticClassIndices.CBaseCombatCharacter);
}