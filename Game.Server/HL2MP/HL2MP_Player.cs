...
public class HL2MP_Player : HL2_Player
{
	...
	]); public static readonly ServerClass SC_HL2MPLocalPlayerExclusive = ServerClass.New(DT_HL2MPLocalPlayerExclusive);
	...
	]); public static readonly ServerClass SC_HL2MPNonLocalPlayerExclusive = ServerClass.New(DT_HL2MPNonLocalPlayerExclusive);
	...
	public static readonly SendTable DT_HL2MP_Player = new(DT_HL2_Player, [
		...
		SendPropExclude(nameof(DT_BaseEntity), nameof(AngRotation)),
	...
	public static new readonly ServerClass ServerClass = ServerClass.New(DT_HL2MP_Player)
