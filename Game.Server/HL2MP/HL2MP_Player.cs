...
public class HL2MP_Player : HL2_Player
{
	public static readonly SendTable DT_HL2MPLocalPlayerExclusive = new([
		SendPropVector(FIELD.OF(nameof(Origin)), -1, PropFlags.NoScale|PropFlags.ChangesOften, 0.0f, Constants.HIGH_DEFAULT),
	...
	public static readonly SendTable DT_HL2MPNonLocalPlayerExclusive = new([
		SendPropVector(FIELD.OF(nameof(Origin)), -1, PropFlags.CoordMPLowPrecision|PropFlags.ChangesOften, 0.0f, Constants.HIGH_DEFAULT),
